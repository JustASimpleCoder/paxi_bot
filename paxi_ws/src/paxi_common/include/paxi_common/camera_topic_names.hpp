...
inline constexpr const char * OAK_D_LITE_RGB_COMPRESSED_DEPTH_TOPIC =
  "/driver/rgb/image_raw/compressedDepth";
...
inline constexpr const char * OAK_D_LITE_STEREO_COMPRESSED_TOPIC =
  "/driver/stereo/image_raw/compressed";

// Stereo info topic name from OAK_D_LIT ros2 brdige
inline constexpr const char * OAK_D_LITE_STEREO_COMPRESSED_DEPTH_TOPIC =
  "/driver/stereo/image_raw/compressedDepth";

// Stereo THEORA info topic name from OAK_D_LIT ros2 brdige
inline constexpr const char * OAK_D_LITE_STEREO_THEORA_RAW_TOPIC =
  "/driver/stereo/image_raw/theora";
